        ...
        <form>
            <div class="  register-top-grid">
                ...
                <div class="mation">
                    ...
                    <?php echo Form::label('last_name', 'Họ'); ?>

                    <?php echo Form::text('last_name', null, ['class' => 'form-control']); ?>


                    <?php echo Form::label('first_name', 'Tên'); ?>
            ...
            <div class="  register-bottom-grid">
                ...
                <div class="mation">
                    ...
                    <?php echo Form::label('re_password', 'Xác nhận mật khẩu'); ?>

                    <?php echo Form::password('re_password', ['class' => 'form-control']); ?>
...
<?php /**PATH C:\wamp64\www\do_an-app\resources\views/modules/mod_register_acc.blade.php ENDPATH**/ ?>