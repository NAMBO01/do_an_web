<div class="container">
    ...
    <div class="sub-cate">
        <div class=" top-nav rsidebar span_1_of_left">
            ...
            <ul class="menu">
                <li class="item1"><a href="#">Curabitur sapien<img class="arrow-img" src="images/arrow1.png"
                            alt="" /> </a>
                    <ul class="cute">
                ...
                <li>
                    <ul class="kid-menu">
                        <li><a href=""/product"">Tempus pretium</a></li>
                        <li><a href=""/product"">Dignissim neque</a></li>
                        <li><a href=""/product"">Ornared id aliquet</a></li>
                    </ul>
                </li>
                <ul class="kid-menu ">
                    <li><a href=""/product"">Commodo sit</a></li>
                    <li><a href=""/product"">Urna ac tortor sc</a></li>
                    <li><a href=""/product"">Ornared id aliquet</a></li>
                    <li><a href=""/product"">Urna ac tortor sc</a></li>
                    <li><a href=""/product"">Eget nisi laoreet</a></li>
                    <li><a href=""/product"">Faciisis ornare</a></li>
...
<?php /**PATH C:\wamp64\www\do-an\do_an-app\resources\views/modules/mod_single.blade.php ENDPATH**/ ?>