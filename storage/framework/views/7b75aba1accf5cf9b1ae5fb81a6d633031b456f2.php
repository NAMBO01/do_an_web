<div class="container">
    <div class=" single_top">
        <div class="single_grid">
            ...
            <div class="desc1 span_3_of_2">
                ...
                <h4><?php echo e($thong_tin_san_pham->ten_san_pham); ?></h4>
                <div class="cart-b">
                    <div class="left-n "><?php echo e($thong_tin_san_pham->don_gia); ?></div>
                    <a class="now-get get-cart-in" href="#">ADD TO CART</a>
                    <div class="clearfix"></div>
                </div>
                <h6>100 items in stock</h6>
                <p><?php echo e($thong_tin_san_pham->gioi_thieu); ?>.</p>
                <div class="share">
                    <h5>Share Product :</h5>
                    <ul class="share_nav">
    ...
    <div class="sub-cate">
        ...
        <div class=" chain-grid menu-chain">
            <a href="/single"><img class="img-responsive chain" src="images/sneaker_bag.jpg"
                    alt=" " /></a>
...
<?php /**PATH C:\wamp64\www\do_an-app\resources\views/modules/mod_single.blade.php ENDPATH**/ ?>