<div class="container">
    ...
    <div class="women-product">
        <div class=" w_content">
            <div class="women">
                ...
                <ul class="w_nav">
                    <li>Sort : </li>
                    <li><a class="active" href="#">Thịnh hành</a></li> |
            ...
            <?php if($list_san_pham): ?>
                <?php $__currentLoopData = $list_san_pham; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $san_pham): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="  product-grid">
                        <div class="content_box"><a href="/single">
                                <div class="left-grid-view grid-view-left">
                                    <img src="images/just_do_it_tshirt.jpg" class="img-responsive watch-right"
                                        alt="" />
                                    <div class="mask">
        ...
        <div class="  product-grid">
            <div class="content_box"><a href="/single">
                    <div class="left-grid-view grid-view-left">
                        <img src="images/tshirt_futura.jpg" class="img-responsive watch-right" alt="" />
                        <div class="mask">
                            <div class="info">Quick View</div>
                        </div>
                </a>
    ...
    <div class="  product-grid">
        <div class="content_box"><a href="/single">
                <div class="left-grid-view grid-view-left">
                    <img src="images/jd1.jpg" class="img-responsive watch-right" alt="" />
                    <div class="mask">
                        <div class="info">Quick View</div>
                    </div>
            </a>
...
<div class="clearfix"> </div>
<?php /**PATH C:\wamp64\www\do_an-app\resources\views/modules/mod_product.blade.php ENDPATH**/ ?>