<div class="container">
    <div class="women-product">
        ...
        <div class="grid-product">
            <?php $__currentLoopData = $list_san_pham_jd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $san_pham_jd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="product-grid">
                    <div class="content_box">
                        <a href="single.html"> </a>
                        <div class="left-grid-view grid-view-left">
                            <img src="images/<?php echo e($san_pham_jd->hinh); ?>" class="img-responsive watch-right" alt="" />
                            <div class="mask">
                                <div class="info">Quick View</div>
                            </div>
                        </div>
                        <h4><a href="#"> <?php echo e($san_pham_jd->ten_san_pham); ?></a></h4>
                        <p><?php echo e($san_pham_jd->gioi_thieu); ?></p>
                        Rs. 499
                    </div>
                </div>
...
<?php /**PATH C:\wamp64\www\do_an-app\resources\views/modules/mod_product_jordan.blade.php ENDPATH**/ ?>