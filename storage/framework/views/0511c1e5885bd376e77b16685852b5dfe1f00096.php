    ...
    <div class="bottom-header">
        <div class="container">
            ...
            <div class="header-bottom-right">
                <div class="account"><a href=<?php echo e(url('login')); ?>><span> </span>TÀI KHOẢN CỦA BẠN</a></div>
                <ul class="login">
                    <li><a href=<?php echo e(url('login')); ?>><span> </span>ĐĂNG NHẬP</a></li> |
                    <li><a href=<?php echo e(url('register')); ?>>ĐĂNG KÝ</a></li>
                </ul>
                <div class="cart"><a href="/cart"><span> </span>GIỎ HÀNG</a></div>
                <div class="clearfix"> </div>
            </div>
            <div class="clearfix"> </div>
        </div>
...
<?php /**PATH C:\wamp64\www\do_an-app\resources\views/widgets/header.blade.php ENDPATH**/ ?>